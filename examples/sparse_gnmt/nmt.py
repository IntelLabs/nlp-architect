...
def add_arguments(parser):
    ...
    parser.add_argument("--warmup_scheme", type=str, default="t2t", choices=["t2t"], help="""\
      How to warmup learning rates. Options include:
        t2t: Tensor2Tensor's way, start with lr 100 times smaller, then
             exponentiate until the specified lr.\
      """)
    parser.add_argument(
        "--decay_scheme", type=str, default="",
    ...
    parser.add_argument("--projection_type", type=str, default="dense",
                        choices=["dense", "sparse"],
                        help="dense | sparse")
    parser.add_argument("--embedding_type", type=str, default="dense",
                        choices=["dense", "sparse"],
                        help="dense | sparse")
    ...
    parser.add_argument("--quantize_ckpt", type="bool", default=False,
                        help="Set to True to produce a quantized checkpoint from existing "
                             "checkpoint")
    parser.add_argument("--from_quantized_ckpt", type="bool", default=False,
    ...
    parser.add_argument("--pruning_hparams", type=str, default=None,
                        help="model pruning parameters")
