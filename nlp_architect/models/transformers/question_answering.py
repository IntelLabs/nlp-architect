...
class TransformerQuestionAnswering(TransformerBase):
                ...
                if (step + 1) % gradient_accumulation_steps == 0:                    
                    ...
                    if logging_steps > 0 and global_step % logging_steps == 0:
                        ...
                        for d in ds:
                            ...
                            results = self.evaluate_predictions(examples=dev_examples, features=dev_features, eval_results=eval_results, 
                                prefix=global_step, data_dir=data_dir)
                            for key, value in results.items():
                                  logger.info('eval_{}: {}. global step: {}'.format(key,value,global_step))
    ...
    def evaluate_predictions(self, eval_results, prefix, examples, features, data_dir):
        # Compute predictions
