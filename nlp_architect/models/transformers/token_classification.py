...
def bert_for_ner_linear_forward(bert, input_ids, token_type_ids=None, attention_mask=None,
...
class BertForTagging(BertForTokenClassification):
    ...
    def forward(self, input_ids, token_type_ids=None, attention_mask=None, labels=None,
        ...
        return bert_for_ner_linear_forward(self, input_ids, token_type_ids=token_type_ids,
