...
def bert_for_ner_linear_forward(bert, input_ids, token_type_ids=None, attention_mask=None, labels=None, position_ids=None, head_mask=None, valid_ids=None):
        outputs = bert.bert(
            input_ids,
...
class BertForTagging(BertForTokenClassification):
    ...
    def forward(self, input_ids, token_type_ids=None, attention_mask=None, labels=None, position_ids=None, head_mask=None, valid_ids=None):
        return bert_for_ner_linear_forward(self, input_ids, token_type_ids=token_type_ids, attention_mask=attention_mask, labels=labels, position_ids=position_ids, head_mask=head_mask, valid_ids=valid_ids)


class QuantizedBertForNERLinear(QuantizedBertForTokenClassification):
