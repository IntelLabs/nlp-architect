...
class MemN2N_Dialog_TF(object):
    ...
    def _build_inputs(self):
        ...
        self._answers = tf.placeholder(tf.int32, [None, self.num_cands], name="answers")
    ...
    def _inference(self, stories, queries):
        with tf.variable_scope(self._name):
            ...
            cands_emb_sum = tf.reduce_sum(cands_emb, 1)
