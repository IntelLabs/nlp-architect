...
from nlp_architect.np_semantic_segmentation.data import NpSemanticSegData
from nlp_architect.np_semantic_segmentation.model import NpSemanticSegClassifier
