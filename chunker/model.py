...
from neon.layers.layer import Layer, LookupTable, Reshape, Dropout, Affine
from neon.layers.recurrent import get_steps, interpret_in_shape, BiLSTM, DeepBiLSTM
from neon.models import Model
from neon.transforms import Logistic, Tanh, Softmax


class ChunkerModel(object):
    """
    Sequence chunker model definition
    """
